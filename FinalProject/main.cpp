...
/* ----------------				Final Project					--------------------------*/
/*-----------------					 2021-1				---------------------------*/
/*-------------		 Alumnos:	Fuentes Diaz Alan Abner                     ---------------*/
...
void LoadTextures()
{
	...
	t_pumas = generateTextures("Texturas/Equipo/pumas.jpg", 0);
	t_papel = generateTextures("Texturas/papel.png", 1);
	t_cube = generateTextures("Texturas/Cube03.png", 1);
}
...
void display(Shader shader)
{
	...
	glBindTexture(GL_TEXTURE_2D, t_cube); //seleccion de textura
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0); //Plano frontal


	shader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
	glBindTexture(GL_TEXTURE_2D, t_cube); //seleccion de la textura
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(6 * sizeof(float)));//Izquierda

	shader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
	glBindTexture(GL_TEXTURE_2D, t_cube); //seleccion de la textura
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(12 * sizeof(float)));//Derecha

	shader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
	glBindTexture(GL_TEXTURE_2D, t_cube);//seleccion de la textura
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(18 * sizeof(float)));//Atras

	shader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
	glBindTexture(GL_TEXTURE_2D, t_cube); //seleccion de la textura
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(24 * sizeof(float)));//Arriba

	shader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
	glBindTexture(GL_TEXTURE_2D, t_cube); //seleccion de la textura
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(30 * sizeof(float))); //Abajo
	*/
	...
	shader.setMat4("model", model);
	shader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
	glBindTexture(GL_TEXTURE_2D, t_pumas);
